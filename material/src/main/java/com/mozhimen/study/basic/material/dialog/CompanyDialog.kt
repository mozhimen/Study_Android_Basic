package com.mozhimen.study.basic.material.dialog
...
import com.mozhimen.study.basic.material.databinding.DialogCompanyBinding
...
class CompanyDialog(private val companyMap: Map<String, Int>, private val selectedTabPosition: Int) : BottomSheetDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, com.mozhimen.uicorek.R.style.ThemeK_DesignLightBottomSheetDialog)
    }
    ...
    class CompanyAdapter(private val context: Context, private val keys: MutableList<String>, private val selectedTabPosition: Int) : RecyclerView.Adapter<CompanyAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if (position == selectedTabPosition) {
                holder.textView.setTextColor(ContextCompat.getColor(context, com.mozhimen.uicorek.R.color.cok_red__d32f2f))
            } else {
