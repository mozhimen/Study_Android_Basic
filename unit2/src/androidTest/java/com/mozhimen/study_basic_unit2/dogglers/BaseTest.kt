...
*/
package com.mozhimen.study_basic_unit2.dogglers
...
import com.mozhimen.study_basic_unit2.dogglers.BaseTest.DrawableMatcher.withDrawable
...
open class BaseTest {
    ...
    fun checkFirstPosition() {
        hasListItemContent("Tzeitel", "Age: 7", "Hobbies: sunbathing", com.mozhimen.study_basic_unit2.R.drawable.tzeitel)
    }
